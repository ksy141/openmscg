...
#define GETPTR() TableAngleBSpline *p; PyArg_ParseTuple(args, "L", &p)
...
PYAPI(create)
{
    ...
    TableAngleBSpline *p = new TableAngleBSpline(lst, tid, order, res, xmin, xmax);
...
static struct PyModuleDef cModPy =
{
    ...
    "cxx_table_angle_bspline", /* name of module */
    "",         /* module documentation, may be NULL */
    -1,         /* keeps state in global variables */
    cModPyMethods
};

PyMODINIT_FUNC PyInit_cxx_table_angle_bspline(void)
{
